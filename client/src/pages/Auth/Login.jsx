...
const Login = () => {
    ...
    <div className="flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <motion.div 
        ...
        <p className="mt-2 text-center text-sm text-blips-text-secondary">
          Or{' '}
          <Link to="/register" className="font-medium text-blips-purple hover:text-blips-purple-dark">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-blips-text-secondary">
                  Remember me
                </label>
              </div>

              <div className="text-sm">
                <a href="#" className="font-medium text-blips-purple hover:text-blips-purple-dark">
  ...
  <div className="relative">
    <div className="absolute inset-0 flex items-center">
      <div className="w-full border-t border-blips-card" />
    </div>
    <div className="relative flex justify-center text-sm">
      <span className="bg-blips-dark px-2 text-blips-text-secondary">Or continue with</span>
    </div>
  </div>
  ...
  <div className="mt-6 grid grid-cols-3 gap-3">
    <button
      type="button"
      className="inline-flex w-full justify-center rounded-md border border-blips-card bg-blips-dark py-2 px-4 text-sm font-medium text-blips-text-secondary shadow-sm hover:bg-blips-card relative"
    ...
    >
      ...
      <span className="absolute -top-2 -right-2 bg-blips-purple text-white text-xs px-2 py-1 rounded-full">Soon</span>
    </button>

    <button
      type="button"
      className="inline-flex w-full justify-center rounded-md border border-blips-card bg-blips-dark py-2 px-4 text-sm font-medium text-blips-text-secondary shadow-sm hover:bg-blips-card relative"
      onClick={() => alert('Twitter login is coming soon!')}
    >
    ...
    <button
      type="button"
      className="inline-flex w-full justify-center rounded-md border border-blips-card bg-blips-dark py-2 px-4 text-sm font-medium text-blips-text-secondary shadow-sm hover:bg-blips-card relative"
      onClick={() => alert('Discord login is coming soon!')}
    >
